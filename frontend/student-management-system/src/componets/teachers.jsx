...
<link rel="stylesheet" href="assets/css/style.css"></link>
       ...
       <Sidebar/>
        ...
        <td>
        <h2 className="table-avatar">
        <a href="teacher-details.html" className="avatar avatar-sm me-2"><img className="avatar-img rounded-circle" src="assets/img/profiles/avatar-08.jpg" alt="User Image"/></a>
        ...
        <td>
        <h2 className="table-avatar">
        <a href="teacher-details.html" className="avatar avatar-sm me-2"><img className="avatar-img rounded-circle" src="assets/img/profiles/avatar-09.jpg" alt="User Image"/></a>
        ...
        <td>
        <h2 className="table-avatar">
        <a href="teacher-details.html" className="avatar avatar-sm me-2"><img className="avatar-img rounded-circle" src="assets/img/profiles/avatar-10.jpg" alt="User Image"/></a>
